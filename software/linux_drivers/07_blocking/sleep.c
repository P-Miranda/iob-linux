...
* 1. insert module: insmod sleep.ko
* 2. nonblocking open: ./user/cat_nonblock /proc/sleep
* 3. blocking open: tail -f /proc/sleep &
* ...
* 4. nonblocking open: ./user/cat_nonblock /proc/sleep
* 5. kill blocking open: pkill tail
* 6. nonblocking open: ./user/cat_nonblock /proc/sleep
 */
...
MODULE_DESCRIPTION("sleep module.");
